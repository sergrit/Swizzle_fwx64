...
Connection Speed Testing in Swizzle:
- In the settings, you can specify a test file to be downloaded.
- The speed test does not aim for precise measurement. Larger files provide higher accuracy, but the test is useful for determining the general order of magnitude (MB/s, KB/s).
...
- Additional arguments (example -s google.com -d 8.8.8.8).
